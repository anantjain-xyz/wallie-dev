-- Include latest agent-run identity/status so the dashboard can distinguish
-- execution failures from human-requested changes without an extra query.
      ...
      coalesce(
        jsonb_agg(
          jsonb_build_object(
            ...
            'id', cr.id,
            'latestRunId', cr.latest_run_id,
            'latestRunStatus', cr.latest_run_status,
