-- Sessions ledger: sort URL state + repository column on the list RPC.
-- Extends get_session_list_page with sort_key / cursor_number and returns
-- repositoryFullName from the session's pinned GitHub repository.
