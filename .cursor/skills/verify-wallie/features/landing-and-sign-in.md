...
- **Use header sign-in.** From `/`, choose `Sign in`. Run `... browser click --role link --name "Sign in"`. The URL becomes `/login` with the same login heading and Work email field.
