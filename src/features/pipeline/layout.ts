...
export const pipelineLayout = {
  page: "flex min-h-[calc(100svh-6.75rem-env(safe-area-inset-top)-env(safe-area-inset-bottom))] flex-col bg-sheet pipeline-wide:h-[calc(100svh-6.75rem-env(safe-area-inset-top)-env(safe-area-inset-bottom))] pipeline-wide:min-h-0 pipeline-wide:lg:h-[calc(100svh-3rem-env(safe-area-inset-top)-env(safe-area-inset-bottom))]",
