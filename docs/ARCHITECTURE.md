...
| Integration adapters | GitHub, Linear, agent runners, encrypted credentials, provider-specific sandbox SDKs                        | [`src/lib/github/`](../src/lib/github/), [`src/lib/agents/`](../src/lib/agents/), [`src/lib/secrets/`](../src/lib/secrets/), [`src/lib/sandbox/`](../src/lib/sandbox/) |
