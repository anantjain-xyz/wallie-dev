...
const expectedScripts = {
  "verify:hygiene": "tsx scripts/verify-workspace-hygiene.ts",
  ...
  test: "vitest run",
  "check:fast":
    "pnpm verify:validation && pnpm verify:hygiene && pnpm format:check && pnpm lint && pnpm typecheck && pnpm check:privileged-imports",
