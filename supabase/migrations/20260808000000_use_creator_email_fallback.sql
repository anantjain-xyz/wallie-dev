-- Resolve creator identity from every human member field populated by workspace
-- creation and invitations. Blank profile values should not hide a usable email.
